...
public class OpenCV_Test extends LinearOpMode {
    ...
    private static final int CAMERA_WIDTH  = 260; // width  of wanted camera resolution
    private static final int CAMERA_HEIGHT = 260; // height of wanted camera resolution
    ...
    double upperruntime = 0;
                            ...
                            //                           Y      Cr     Cb
    public static Scalar scalarLowerYCrCb = new Scalar(100.0, 100.0, 100.0);
...
//        FtcDashboard.getInstance().startCameraStream(webcam, 10);
        ...
        while (opModeIsActive())
        {
            ...
            if(myPipeline.getRectArea() > 210){
                if(myPipeline.getRectMidpointX() > 150 && myPipeline.getRectMidpointX() < 200){
                    AUTONOMOUS_C();
                }
                else if(myPipeline.getRectMidpointX() > 60 && myPipeline.getRectMidpointX() < 90){
                    AUTONOMOUS_B();
                }
                else{
                    AUTONOMOUS_A();
