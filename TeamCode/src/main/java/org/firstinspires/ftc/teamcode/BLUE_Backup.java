...
@Autonomous(name = "BLUE_Backup",group = "Redbot")
public class BLUE_Backup extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (GLOBAL_SKYBLOCK_POS) {
                case 6:
                    //sample_L_servo("open");
                    while (opModeIsActive()) {
                        if (robot.dis_left.getDistance(DistanceUnit.INCH) < 28) {
                ...
                case 5:
                    //sample_R_servo("open");
                    while (opModeIsActive()) {
                        if (robot.dis_left.getDistance(DistanceUnit.INCH) < 30) {
                            choosingState(power, "Strafe Right");
                        } else {
                            break;
                        }
            ...
            switch (SECOND_SKYBLOCK_POS) {
                ...
                case 2:
                    while (opModeIsActive()) {
                        if (robot.dis_left.getDistance(DistanceUnit.INCH) > 12) {
                            choosingState(power, "Strafe Left");
                        } else {
                            break;
                        }
                ...
                case 1:
                    while (opModeIsActive()) {
                        if (robot.dis_left.getDistance(DistanceUnit.INCH) > 1) {
                            choosingState(power, "Strafe Left");
                        } else {
                            break;
                        }
            ...
            switch (THIRD_SKYBLOCK_POS) {
                case 6:
                    while (opModeIsActive()) {
                        if (robot.dis_left.getDistance(DistanceUnit.INCH) > 32) {
                            choosingState(power, "Strafe Left");
                        } else {
                            break;
                        }
                ...
                case 5:
                    while (opModeIsActive()) {
                        if (robot.dis_left.getDistance(DistanceUnit.INCH) > 26) {
                            choosingState(power, "Strafe Left");
                        } else {
                            break;
                        }
            ...
            //and alter their position
            while (opModeIsActive()) {
                if (robot.dis_left.getDistance(DistanceUnit.INCH)>35) {
                    choosingState(power,"Strafe Left");
                }
                else {
                    break;
            ...
            switch (FOURTH_SKYBLOCK_POS) {
                ...
                case 5:
                    while (opModeIsActive()) {
                        if (robot.dis_left.getDistance(DistanceUnit.INCH) > 33) {
                            choosingState(power, "Strafe Left");
                        } else {
                            break;
                        }
