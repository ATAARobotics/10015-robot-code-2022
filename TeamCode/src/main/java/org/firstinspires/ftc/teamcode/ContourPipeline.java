...
{
    Scalar WHITE = new Scalar(-140, -140, -140);
    ...
    // Green Y Cr Cb
    //public static Scalar scalarLowerYCrCb = new Scalar( 180, 180.0, 180.0);
    //public static Scalar scalarUpperYCrCb = new Scalar(185.0, 185.0, 185.0);
    ...
    private Rect maxRect = new Rect(0,0,120,60);
    private Rect rect = new Rect(0,0,120,60);
    ...
    public Mat processFrame(Mat input)
    {
        ...
        try
        {
            ...
            // Draw Borders
            Imgproc.rectangle(output, new Rect(borderLeftX, borderTopY, CAMERA_WIDTH - borderRightX - borderLeftX, CAMERA_HEIGHT - borderBottomY - borderTopY), WHITE, 2);
            // Display Data
