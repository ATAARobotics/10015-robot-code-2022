...
//   StageSwitchingPipeline detector;
    ...
    public int stone_loc(int threshold_val) {
        int stone_pos = valLeft<=threshold_val ? 4: valRight<=threshold_val ? 6
                : valMid <=threshold_val ? 5 : 0;
        return stone_pos;
    }
    public int stone_loc_blue(int threshold_val) {
        int stone_pos = valRight<=threshold_val ? 4: valLeft<=threshold_val ? 6
                : valMid <=threshold_val ? 5 : 0;
        return stone_pos;
    }
